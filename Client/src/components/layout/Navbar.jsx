                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden md:flex items-center gap-10">
                        <Link
                            ...
                            className={`font-bold text-sm uppercase tracking-widest transition-colors duration-300 flex items-center gap-2 relative ${linkStyle} ${activeSection === 'home' ? 'after:absolute after:bottom-[-8px] after:left-0 after:right-0 after:h-0.5 after:bg-primary-600 after:rounded-full' : ''
                                }`}
                        >
                            <Home size={16} /> Home
                        </Link>
                        <a
                            ...
                            className={`font-bold text-sm uppercase tracking-widest transition-colors duration-300 flex items-center gap-2 relative ${linkStyle} ${activeSection === 'wings' ? 'after:absolute after:bottom-[-8px] after:left-0 after:right-0 after:h-0.5 after:bg-primary-600 after:rounded-full' : ''
                                }`}
                        >
                        ...
                        >
                            <div className={`rounded-2xl p-4 space-y-4 ${(scrolled || !isHomePage)
                                ...
                                <Link
                                    ...
                                    className={`flex items-center gap-3 p-3 rounded-xl transition-all relative ${activeSection === 'home'
                                ...
                                <a
                                    ...
                                    className={`flex items-center gap-3 p-3 rounded-xl transition-all relative ${activeSection === 'wings'
                                        ? 'bg-primary-600 text-white border-l-4 border-primary-700'
                                        : (scrolled || !isHomePage)
                                            ? 'text-primary-600 hover:bg-primary-50'
                                            : 'text-white hover:bg-white/10'
